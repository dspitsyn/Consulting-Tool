	...
	SELECT @Version = '4.58', @VersionDate = '20200908 21:37:47';
	...
	BEGIN
		...
		PRINT '
			Version: 2009.370908 - August, 2020
			Summary:
				...
				<td width = "50%" height = "30">' +
					...
					CASE WHEN @@VERSION LIKE '%Microsoft SQL Server 2017%'
						THEN 'Das neueste kumulative Update (' + [Service Pack] +
							') wurde vom Hersteller am 10. September, 2020 veröffentlicht und muss installiert werden. <br>' +
					...
					+ '<br><b>' + 'Informationen zum Neustart' + '</b><br>' 
					+ 'Ein Neustart des Servers ist erforderlich.' + '<br>'
					
					/*
					+ '<b>' + 'SQL-Leistung: ' + '</b>' + 'Assertionsfehler tritt auf, wenn die resumeable Index Build-Anweisung ausgeführt ist' + '<br>'
					*/
	...
	*/
	...
	/*
		| 10.9 - Diagnose potential CPU pressure based on https://docs.microsoft.com/en-us/previous-versions/technet-magazine/dn383732(v=msdn.10)?redirectedfrom=MSDN
	...
	BEGIN
		...
		BEGIN
			...
			CREATE TABLE #CausesOfWaits (
				...
				, [WaitTime] DECIMAL(20,2)	--DATETIME
					...
					'<tr>
						...
						'<td width = "50%" height = "30">' +
							...
							'Potenzielle Ursache' + (
								SELECT 
									CASE WaitType 
										WHEN 'SQLTRACE_INCREMENTAL_FLUSH_SLEEP' THEN ': Ausführung des Profiler auf dem Produktionssystem muss vermieden werden.' 
